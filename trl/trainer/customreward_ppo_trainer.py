...
class CustomRewardPPOTrainer(Trainer):
    _tag_names = ["trl", "custom_reward_ppo"]
    ...
    def get_reward(
        ...
        _, score, _ = get_reward(self.reward_model, query_responses, pad_token_id, context_length)[1]
        return score