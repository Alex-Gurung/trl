...
@dataclass
class GFlowNetConfig(OnPolicyConfig):
    r"""
    Configuration class for the [`GFlowNetTrainer`].
    ...
    Parameters:
        ...
        num_gflownet_epochs (`int`, *optional*, defaults to `4`):
